...
namespace NetConf.Xncf.Admin.Models.DatabaseModel
{
    ...
    /// <para>2、运行：PM> add-migration [更新名称] -c AdminSenparcEntities_SqlServer -o Migrations/Migrations.SqlServer </para>
    /// </summary>
    public class SenparcDbContextFactory_SqlServer : SenparcDesignTimeDbContextFactoryBase<AdminSenparcEntities_SqlServer, Register>
    {
